...
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city) VALUES ('neota', 'minneapolis' );

-- 9. The bank is losing money in Miami and Phoenix and needs to unload low transaction
--customers: Delete users that reside in miami OR phoenix and have completed fewer than 5 transactions.
